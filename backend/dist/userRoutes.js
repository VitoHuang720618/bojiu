...
export function createUserRoutes(authService, userService, authMiddleware) {
     ...
     */
    router.post('/auth/logout', authMiddleware.authenticate(), (req, res) => {
     ...
     */
    router.get('/auth/me', authMiddleware.authenticate(), (req, res) => {
        res.json({
            success: true,
            user: req.user
        });
     ...
     */
    router.post('/auth/change-password', authMiddleware.authenticate(), async (req, res) => {
        try {
