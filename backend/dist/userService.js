...
export class UserService {
    ...
    async createUser(userData) {
        ...
        try {
            ...
            // Log audit event
            await this.dbService.logAuditEvent(null, 'USER_CREATED', `User created: ${userData.username} (${userData.email})`);
    ...
    async updateUser(id, userData) {
        try {
            ...
            // Log audit event
            await this.dbService.logAuditEvent(id, 'USER_UPDATED', `User updated: ${updatedDbUser.username}`);
    ...
    async deleteUser(id) {
        try {
            ...
            if (deleted) {
                ...
                await this.dbService.logAuditEvent(null, // Use null instead of deleted user ID to avoid foreign key constraint
                'USER_DELETED', `User deleted: ${user.username} (ID: ${id})`);
            }
            return deleted;
        }
        catch (error) {
     ...
     */
    convertDatabaseUserToUser(dbUser) {
        return {
            id: dbUser.id,
