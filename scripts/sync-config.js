...
const fileContent = `import type { SiteConfig } from '../types'
...
export const routeLinksImages = ${JSON.stringify(routeLinksImages, null, 2)}

export const recommendedRoutes = ${JSON.stringify(recommendedRoutes, null, 2)}

export const recommendedTools = ${JSON.stringify(recommendedTools, null, 2)}

export const videoThumbnails = ${JSON.stringify(videoThumbnails, null, 2)}

export const programThumbnails = ${JSON.stringify(programThumbnails, null, 2)}

export const carouselSlides = ${JSON.stringify(carouselSlides, null, 2)}

export const floatAdButtons = ${JSON.stringify(floatAdButtons, null, 2)}
